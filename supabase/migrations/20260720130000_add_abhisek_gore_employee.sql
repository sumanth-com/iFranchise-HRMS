-- Add Motion Graphics Designer designation and seed Abhisek Gore (IF2026016).

INSERT INTO hrms.designations (id, organization_id, title, code, level, status)
VALUES
  (
    'b0000000-0000-4000-8000-000000000321',
...
BEGIN
  ...
  FOR v_rec IN
    SELECT * FROM (VALUES
      ('e1000000-0000-4000-8000-000000000001'::uuid, 'IF2026001', 'Ekta', 'Pattanaik', 'hr@ifranchise.in', '9337213031', 'b0000000-0000-4000-8000-000000000314'::uuid, v_dept_hr, v_emp_full_time, DATE '2026-01-17', DATE '2026-04-17', DATE '2000-04-12', '252633984995', 'FTSPP1164A', 3::numeric, false, NULL::text, 'female'::hrms.gender_type),
      ...
      ('e1000000-0000-4000-8000-000000000008'::uuid, 'IF2026012', 'Akshita', 'Potnuru', 'akshita.potnuru@ifranchise.in', '7337430010', 'b0000000-0000-4000-8000-000000000319'::uuid, v_dept_hr, v_emp_intern, DATE '2026-05-04', DATE '2026-08-04', DATE '2000-12-14', '648319238827', 'DHXPA4553B', 0::numeric, true, 'IF2026001', 'female'::hrms.gender_type),
      ...
      ('e1000000-0000-4000-8000-000000000011'::uuid, 'IF2026016', 'Abhisek', 'Gore', 'abhishek@ifranchise.in', '9325363976', 'b0000000-0000-4000-8000-000000000321'::uuid, v_dept_marketing, v_emp_intern, DATE '2026-07-15', DATE '2026-10-15', DATE '2003-10-02', '253469189368', 'EELPG1916L', 0::numeric, true, NULL::text, 'male'::hrms.gender_type)
