...
export function DashboardShellFallback() {
  return (
    <div className="app-shell-canvas flex h-dvh min-h-0 overflow-hidden bg-background" aria-busy="true" aria-live="polite">
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <main className="app-shell-main relative flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
          <DashboardSkeleton />
        </main>
      </div>
    </div>
