...
import {
  ONBOARDING_TERMS_BLOCKS,
  ONBOARDING_TERMS_INTRO,
} from "@/lib/onboarding/onboarding-terms-content";
  ...
  return (
    <div className="mx-auto min-w-0 max-w-3xl space-y-4">
      <p className="text-center text-sm text-muted-foreground">
        Please read the Terms & Conditions below. Check the box at the end to confirm and
        continue.
      </p>
      ...
      >
        <div className="space-y-5 text-sm leading-relaxed text-foreground">
          <p className="text-muted-foreground">{ONBOARDING_TERMS_INTRO}</p>
      ...
      <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-border bg-muted/20 p-4 text-sm transition-colors hover:bg-muted/30">
        ...
        <span>
          ...
          <span className="mt-1 block text-xs text-muted-foreground">
            This confirms your acknowledgement of employment, workplace, confidentiality, data
            protection, and related policies required to complete onboarding.
          </span>
        </span>
      </label>
    </div>
