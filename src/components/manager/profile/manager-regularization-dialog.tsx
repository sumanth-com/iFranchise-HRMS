...
import { requestManagerAttendanceRegularizationAction } from "@/lib/manager/actions/manager-self-attendance-actions";
...
export function ManagerRegularizationDialog({
  row,
  open,
  onOpenChange,
}: Props) {
