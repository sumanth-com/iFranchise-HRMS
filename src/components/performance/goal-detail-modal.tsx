                    ...
                    <li
                      ...
                      className={
                        milestone.isCompleted
                          ? "flex items-start justify-between gap-3 rounded-md border border-emerald-500/25 bg-emerald-500/5 px-3 py-2.5"
                          : "flex items-start justify-between gap-3 rounded-md border border-amber-500/20 bg-amber-500/5 px-3 py-2.5"
                      }
                    >
                      ...
                      {canToggleMilestones ? (
                        ...
                        <PerformanceStatusBadge
                          label={milestone.isCompleted ? "Done" : "Pending"}
